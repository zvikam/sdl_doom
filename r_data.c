...
void R_InitTextures (void)
{
    ...
    textures = Z_Malloc (numtextures*POINTER_SIZE, PU_STATIC, 0);
    texturecolumnlump = Z_Malloc (numtextures*POINTER_SIZE, PU_STATIC, 0);
    texturecolumnofs = Z_Malloc (numtextures*POINTER_SIZE, PU_STATIC, 0);
    texturecomposite = Z_Malloc (numtextures*POINTER_SIZE, PU_STATIC, 0);
